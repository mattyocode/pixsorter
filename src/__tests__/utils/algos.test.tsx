...
import { compareFnTypes } from "../../utils/algos/pixel-comparison";

// ---- Pixel comparison functions ---- //
// Compare red pixel value in RGBA value array
const compareFirst: compareFnTypes = (array, index) => {
  return array[index];
};
// Compare blue pixel value in RGBA value array
const compareSecond: compareFnTypes = (array, index) => {
  return array[index + 1];
};
// Compare green pixel value in RGBA value array
const compareThird: compareFnTypes = (array, index) => {
  return array[index + 2];
};
// Compare sum of RGB pixels
const compareAll: compareFnTypes = (array, index) => {
...
describe("Merge sort tests", () => {
  let testSortPosition: null | number = null;
  test("sorts three pixels", () => {
    let testArray = new Uint8ClampedArray([2, 8, 8, 8, 3, 7, 7, 7, 1, 9, 9, 9]);
    let sortedCallback = jest.fn();
    const endSortPosition = mergeSort(
      testArray,
      sortedCallback,
      compareFirst,
      testSortPosition,
    ...
    expect(sortedCallback).toHaveBeenCalled();
    expect(testArray).toEqual(
      new Uint8ClampedArray([1, 9, 9, 9, 2, 8, 8, 8, 3, 7, 7, 7])
    );
  });
